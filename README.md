...
This repo is a significant rework of MeaLeon to something compatible with FastAPI and OpenAPI.

The [FastAPI/Alembic/SQLModel/Async repo](https://github.com/jonra1993/fastapi-alembic-sqlmodel-async) is used as a template

## Table of Contents
- [MeaLeon v2](#mealeon-v2)
  - [What's different with V2](#whats-different-with-v2)
  - [Table of Contents](#table-of-contents)
  - [Prerequisites](#prerequisites)
    - [Set environment variables](#set-environment-variables)
  - [Docker engine](#docker-engine)
  - [Make](#make)
  - [Python "\>3.9,\<3.12"](#python-39312)
  - [Poetry](#poetry)
    - [Dev tip to activate virtual environment](#dev-tip-to-activate-virtual-environment)
  - [Run the project using Docker containers and forcing build containers](#run-the-project-using-docker-containers-and-forcing-build-containers)
  - [Run project using Docker containers](#run-project-using-docker-containers)
  - [Setup database with initial data](#setup-database-with-initial-data)
  - [ERD Database model](#erd-database-model)
  - [Containers architecture](#containers-architecture)
  - [Preview](#preview)
  - [Static files](#static-files)
  - [Minio server](#minio-server)
  - [Celery](#celery)
  - [Run Alembic migrations (Only if you change the DB model)](#run-alembic-migrations-only-if-you-change-the-db-model)
    - [Using docker compose command\*](#using-docker-compose-command)
    - [Using Makefile command](#using-makefile-command)
  - [Production Deployment](#production-deployment)
    - [Using docker compose command](#using-docker-compose-command-1)
  - [Database unique IDs](#database-unique-ids)
  - [Code Style](#code-style)
  - [SonarQube static analysis](#sonarqube-static-analysis)
  - [Testing](#testing)
  - [Type checker](#type-checker)
  - [Basic chatbot example with Langchain and OpenAI](#basic-chatbot-example-with-langchain-and-openai)
...
3. Copy **projectKey** and **login** and replace on *backend/sonar-project.properties* file.
...
4. Run the following command to execute a new code scan
...
- [] Update README for MeaLeon specific information
- [] Look at integration with FlavorDB
- [] Split out functions of MeaLeon as microservices where possible

### Support and Maintenance

MeaLeon is supported by Aaron Chen

The template repo is supported by the [Allient development team](https://www.allient.io/).
